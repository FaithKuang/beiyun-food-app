      ...
      nutrients: [
        {
          ...
          foods: ["猪肝", "菠菜", "小白菜", "空心菜", "芦笋", "黄豆", "橘子", "奇异果"],
        },
        {
          name: "优质蛋白",
          short: "蛋",
        ...
        },
        {
          ...
          foods: ["牛奶", "酸奶", "生蚝", "牡蛎", "扇贝", "瘦牛肉", "羊肉", "鸡蛋", "黑豆", "黄豆", "鲤鱼"],
        },
        {
          name: "维生素 C / E",
          short: "抗",
          benefit: "来自水果、坚果和绿叶菜的抗氧化营养，适合作为每日加餐。",
          foods: ["酸枣", "猕猴桃", "草莓", "柑橘", "核桃", "杏仁", "花生", "桑葚"],
        },
        {
          name: "蔬果轮换",
          short: "蔬",
          benefit: "把红橙色蔬果、海藻和豆类穿插到一周里，补充植物营养和膳食纤维。",
          foods: ["胡萝卜", "西红柿", "西瓜", "葡萄", "木瓜", "海藻", "菠菜", "黑豆"],
        },
      ],
    },
    cycle_window: {
